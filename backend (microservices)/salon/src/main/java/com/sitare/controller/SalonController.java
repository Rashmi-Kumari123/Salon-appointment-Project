...
import com.sitare.mapper.SalonMapper;
...
public class SalonController {
    ...
    public ResponseEntity<SalonDTO> updateSalon(
        ...
        UserDTO user=userService.getUserById(updatedSalon.getOwnerId());
    ...
    public ResponseEntity<List<SalonDTO>> getAllSalons() throws UserException {
        ...
        for (Salon salon1 : salons) {
            UserDTO owner = userService.getUserById(salon1.getOwnerId());
    ...
    public ResponseEntity<SalonDTO> getSalonById(@PathVariable Long salonId) throws Exception {
        ...
        UserDTO user=userService.getUserById(salon.getOwnerId());
